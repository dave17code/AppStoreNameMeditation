...
struct Model {
    ...
    let nameInBibleVerseDictionary: [[String: String]] = [
        ...
        ["민수기 6:24-26": "여호와는 name에게 복을 주시고 name을 지키시기를 원하며 여호와는 그의 얼굴을 name에게 비취사 은혜 베푸시기를 원하며 여호와는 그 얼굴을 name에게로 향하여 드사 평강 주시기를 원하노라"],
        ...
        ["시편 1:1-2": "복 있는 사람 name은 악인의 꾀를 좇지 아니하며 죄인의 길에 서지 아니하며 오만한 자의 자리에 앉지 아니하고 오직 여호와의 율법을 즐거워하여 그 율법을 주야로 묵상하는도다"],
        ...
        ["잠언 3:7": "name은 스스로 지혜롭게 여기지 말지어다 여호와를 경외하며 악을 떠날지어다"],
        ...
        ["이사야 53:5": "그가 찔림은 name의 허물 때문이요 그가 상함은 name의 죄악 때문이라 그가 징계를 받음으로 name은 평화를 누리고 그가 채찍에 맞음으로 name은 나음을 받았도다"],
        ...
        ["마태복음 5:14": "name은 세상의 빛이라 산 위에 있는 동네가 숨기우지 못할 것이요"],
        ...
        ["요한복음 8:32": "진리를 알지니 진리가 name을 자유롭게 하리라"],
        ...
        ["로마서 8:38-39": "내가 확신하노니 사망이나 생명이나 천사들이나 권세자들이나 현재 일이나 장래 일이나 능력이나 높음이나 깊음이나 다른 아무 피조물이라도 name을 우리 주 그리스도 예수 안에 있는 하나님의 사랑에서 끊을 수 없으리라"],
        ...
        ["에베소서 3:20": "name 가운데서 역사하시는 능력대로 name의 온갖 구하는 것이나 생각하는 것에 더 넘치도록 능히 하실 이에게"],
        ...
        ["빌립보서 4:19": "name의 하나님이 그리스도 예수 안에서 영광 가운데 그 풍성한 대로 name의 모든 쓸 것을 채우시리라"],
        ...
        ["야고보서 4:7": "그런즉 name은 하나님께 순복할지어다 마귀를 대적하라 그리하면 name을 피하리라"],
    ...
    let originalBibleVerseDictionary: [[String: String]] = [
        ...
        ["시편 1:1-2": "복 있는 사람은 악인의 꾀를 좇지 아니하며 죄인의 길에 서지 아니하며 오만한 자의 자리에 앉지 아니하고 오직 여호와의 율법을 즐거워하여 그 율법을 주야로 묵상하는도다"],
        ...
        ["시편 91:1-2": "지존자의 은밀한 곳에 거하는 자는 전능자의 그늘 아래 거하리로다 내가 여호와를 가리켜 말하기를 그는 나의 피난처요 나의 요새요 나의 의뢰하는 하나님이라 하리니"],
