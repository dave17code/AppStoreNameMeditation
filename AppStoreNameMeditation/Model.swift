...
struct Model {
    ...
    let font: [(fontName: String, displayName: String)] = [("BMYEONSUNG-OTF", "배달의민족 연성체"), ("MangoDdobak-R", "망고보드 또박체"), ("Cafe24Supermagic-OTF-Regular", "카페24슈퍼매직"), ("omyu_pretty", "오뮤다예쁨체"), ("TheJamsilOTF2Light", "롯데 더잠실체"), ("KimjungchulScript-Regular", "김정철 손글씨"), ("KCC-Chassam", "KCC 차쌤체"), ("Dovemayo_wild", "거친둘기마요")]
